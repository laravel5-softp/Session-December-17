...
<div class="row">
      <div class="medium-12 large-12 columns">
        <h4>{{ (isset($modify) && $modify  == 1) ? 'Modify Client' : 'New Client' }}</h4>
        <form action="{{ (isset($modify) && $modify  == 1) ? route('update_client', [ 'client_id' => $client_id ]) : route('create_client') }}" method="post">
